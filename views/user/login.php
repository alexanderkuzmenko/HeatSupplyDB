<section id="login-section">
  <div class="container">
    <h1 class="text-center">Вхід до свого кабінету</h1>
    <div class="card">
      <div class="card-body">
        <h5 class="card-title text-center">Введіть email та пароль для входу</h5>
          ...
          <div class="col-md-6">
            <form action="/login" method="post">
              ...
              <div class="form-group text-center mt-4">
                <input type="submit" class="btn btn-success btn-lg" value="Увійти">
              </div>
            </form>        
          </div>
        </div>
