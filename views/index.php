...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/1aa8404e5d.js"></script>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <?php if (!$user->auth): ?>
              <li class="nav-item">
                <a class="nav-link" href="/login">Вхід в систему</a>
              </li>
              <li class="nav-item">
  ...
  <main>
    <section id="log">
      <div class="container">
        ...
        <?php if (!empty($log)): ?>
          <?php foreach ($log as $logKey => $logItem): ?>
            <?php foreach ($logItem as $logValue): ?>
              <div class='alert alert-<?= $logKey; ?>'><?= $logValue; ?></div>
            <?php endforeach; ?>
          <?php endforeach; ?>
        <?php endif; ?>
      </div>
